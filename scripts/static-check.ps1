...
try {
  ...
  foreach ($check in @(
    ...
    @{ Path = 'extension\direct-network-diagnostics.js'; Pattern = 'splitDirectObservationError' },
    ...
    @{ Path = 'extension\service-worker.js'; Pattern = 'failure.persistentMessage' },
    ...
    @{ Path = 'extension\tests\service-worker-transient-failure.test.js'; Pattern = 'keeps AD1 transient while persisting only baseline failure' },
